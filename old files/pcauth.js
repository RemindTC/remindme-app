...
router.post('/login', function(req, res) {
  ...
  pool.query('SELECT * FROM users WHERE email = $1', [email]).then(function(result) {
    ...
    bcrypt.compare(password, user.password_hash).then(function(match) {
...
// Admin: Get all users
router.get('/admin/users', authenticateToken, function(req, res) {
...
// Admin: Block a user
router.post('/admin/users/:id/block', authenticateToken, function(req, res) {
...
router.post('/admin/users/:id/unblock', authenticateToken, function(req, res) {
...
// Admin: Delete a user
router.delete('/admin/users/:id', authenticateToken, function(req, res) {
